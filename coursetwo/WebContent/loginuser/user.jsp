            ...
            <li class="dropdown hidden-xs">
              ...
              <ul class="dropdown-menu">
                <li><a tabindex="-1" href="${ctx }/userinfo/edit?loginName=${name}">修改个人信息</a></li>
                 <li><a tabindex="-1" href="${ctx}/login.jsp">注销</a></li></li>
              </ul>
            </li>
          </ul>
    ...
    <div class="content">
        <div class="header">
           ...
           <c:if test="${action=='edit' }">
			...
			<c:if test="${action!='edit' }">
			<h1 class="page-title">新增个人信息</h1>
                    <ul class="breadcrumb">
            <li><a href="${ctx }/main.jsp">首页</a> </li>
            <li class="active">新增个人信息</li>
			</c:if>
...
<div class="btn-toolbar list-toolbar">
    	<c:if test="${action=='edit' }">
			<form action="${ctx }/userinfo/edit" method="post">
			</c:if>
			<c:if test="${action!='edit' }">
			<form action="${ctx }/userinfo/add" method="post">
			</c:if>
				用&nbsp;&nbsp;户&nbsp;&nbsp;名：<input type="text" name="loginName" value="${u.loginName }" />&nbsp;(提示：用户名不可修改)<br><br>
				密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：<input type="text" name="password" value="${u.getLoginUser().getPassword()}" /><br><br>
				邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input type="text" name="email" value="${u.getLoginUser().getEmail()}" /><br><br>
				真实姓名：<input type="text" name="realName" value="${u.realName}" /><br><br>
				出生日期：<input type="text" name="birthday" value="${u.birthday}" /><br><br>
				角&nbsp;&nbsp;色&nbsp;i&nbsp;d：<input type="text" name="roleid" value="${u.getLoginUser().getRole().getRoleId()}" /><br><br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
