    ...
    <div class="content">
        <div class="header">
           ...
           <c:if test="${action=='edit' }">
			...
			<c:if test="${action!='edit' }">
			<h1 class="page-title">招聘人员</h1>
                    <ul class="breadcrumb">
            <li><a href="${ctx }/main.jsp">首页</a> </li>
            <li class="active">招聘人员</li>
			</c:if>
...
<div class="btn-toolbar list-toolbar">
    	<c:if test="${action=='edit' }">
			<form action="${ctx }/loginuser/edit" method="post">
			</c:if>
			<c:if test="${action!='edit' }">
			<form action="${ctx }/loginuser/add" method="post">
			</c:if>
				用&nbsp;&nbsp;户&nbsp;&nbsp;名：<input type="text" name="loginName" value="${l.loginName }" />&nbsp;(提示：修改用户信息时用户名不可修改，添加用户时可以修改)<br><br>
				邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input type="text" name="email" value="${l.email}" /><br><br>
				密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：<input type="text" name="password" value="${l.password}" /><br><br>
				真实姓名：<input type="text" name="realName" value="${l.getUserInfo().getRealName()}" /><br><br>
				出生日期：<input type="text" name="birthday" value="${l.getUserInfo().getBirthday()}" /><br><br>
				角&nbsp;&nbsp;色&nbsp;i&nbsp;&nbsp;d：<input type="text" name="roleid" value="${l.role.getRoleId()}" /><br><br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
