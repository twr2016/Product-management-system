...
function deleteall(){
	...
	window.location.href="${ctx }/loginuser/deleteall?values="+value;
}
function checkall(){
...
function checkevery(){
	...
	function search(){
		...
		window.location.href="${ctx }/loginuser/list?searchParam="+p;
    ...
    <div class="content">
        <div class="header">
            ...
            <h1 class="page-title">人事管理</h1>
                    <ul class="breadcrumb">
            <li><a href="${ctx}/loginuser/list.jsp">首页</a> </li>
...
<table class="table">
  ...
  <tbody>
    ...
    <c:forEach items="${page.list }" var="l">
					<tr>
					    <td><input type="checkbox" name="single" value="${l.loginName}" onclick="checkevery()"/></td>
						<td>${l.loginName}</td>
						<td>${l.password }</td>
						<td>${l.email }</td>
						<td>${l.role.getName() }</td>
						<td>${l.role.getRoleId() }</td>
						 <td>
          <a href="${ctx }/loginuser/edit?loginName=${l.loginName }"><i class="fa fa-pencil"></i></a>
          <a href="${ctx }/loginuser/delete?loginName=${l.loginName }" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
      </td>
					</tr>
				</c:forEach>
  </tbody>
...
<ul class="pagination">
  ...
  <c:forEach begin="1" end="${page.totalPageNum }" var="pageNum">
						<li><a name="pagen" href="${ctx }/loginuser/list?pageNum=${pageNum }">${pageNum }</a></li>
					</c:forEach>
